...
class Purchase implements ModelInterface, ArrayAccess
{
    ...
    const ORIGIN_STATUS_IMPORT_PENDING = 'import_pending';
    const ORIGIN_STATUS_IMPORTED = 'imported';
    const ORIGIN_STATUS_ERROR_IN_IMPORT = 'error_in_import';
    const ORIGIN_STATUS_IGNORE_IN_IMPORT = 'ignore_in_import';
     ...
     *
     * @param \SSB\Api\Model\Money $subTotalWithoutTax subTotalWithoutTax
     *
     * @return $this
     */
